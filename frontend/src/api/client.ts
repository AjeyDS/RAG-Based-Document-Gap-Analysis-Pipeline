...
export async function getKnowledgeBaseFiles(): Promise<KnowledgeBaseFile[]> {
  ...
  const response = await authFetch(`${API_BASE}/api/knowledge-base?t=${Date.now()}`, {
    cache: "no-store",
    headers: {
      "Pragma": "no-cache",
...
export async function uploadKnowledgeBaseFiles(
  ...
  const response = await authFetch(`${API_BASE}/api/knowledge-base/upload`, {
    method: "POST",
    body: formData,
  });
...
export async function removeKnowledgeBaseFile(
  ...
  const response = await authFetch(`${API_BASE}/api/knowledge-base/${fileId}`, {
    method: "DELETE",
  });
...
export async function compareDocuments(
  ...
  const response = await authFetch(`${API_BASE}/api/documents/compare`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
export async function generateGapContent(
  ...
  const response = await authFetch(`${API_BASE}/api/gaps/generate`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
