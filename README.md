...
**Features**: Gap analysis · Conversational KB chat · Session-based authentication (admin/user roles)
...
Default credentials seeded on startup: `admin1/admin1pass`, `user1/user1pass`. **Change these before any production deployment.**
